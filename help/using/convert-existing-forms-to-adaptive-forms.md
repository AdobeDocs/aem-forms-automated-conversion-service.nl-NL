...
* **(optioneel)** [**Bronformulieren converteren naar Adobe Sign-PDF forms**](frequently-asked-questions.md)
...
* Lees de [Bekende problemen](known-issues.md) en de [Aanbevolen werkwijzen en overwegingen](styles-and-pattern-considerations-and-best-practices.md) secties te openen en wijzigingen in formulieren aan te brengen.
...
1. Tikken **[!UICONTROL Create]**> **[!UICONTROL Folder]**. Opgeven **Titel** en **Naam** van de map. Tik op **[!UICONTROL Create]**. Er wordt een map gemaakt.
1. Tik om de nieuwe map te openen.
1. Tikken **[!UICONTROL Create]**> **[!UICONTROL File Upload]**. Selecteer de formulieren die u wilt uploaden, klikt u op **[!UICONTROL Open]** en klik op **[!UICONTROL Upload]**. De formulieren worden geüpload.
...
* (Alleen AEM Forms as a Cloud Service) De [Secties automatisch omzetten in fragmenten] Deze optie geldt voor PDF forms met meer dan 15 pagina&#39;s. De gedetecteerde bovenste secties worden omgezet in fragmenten. Ook wordt het uitladen van alle gemaakte fragmenten ingeschakeld. Het verbetert de rendersnelheid van geconverteerde formulieren en maakt het gemakkelijker om grote formulieren in een adaptieve formuliereditor te laden.
