...
| **Foutbericht** <br>Kan geen verbinding maken met de service.  <br><br>**Reden** <br> de Onjuiste dienst URL of geen dienst URL wordt vermeld in de clouddiensten van de Dienst van de Automatede form conversion (AFCS). <br><br>**Resolutie** <br> Correct [ Dienst URL ](configure-service.md#configure-the-cloud-service) in de Diensten van de Wolk van de Automatede form conversion (AFCS). | ![Kan geen verbinding maken met de service.](assets/wrong-service-url-configured.png) |
...
| **Fout (milieu&#39;s op-gebouw slechts)** <br> de **[!UICONTROL Source Language]** optie maakt geen lijst van de correcte taal van een AanpassingsVorm. <br><br>**Reden** <br> Jcr:language het bezit van de adaptieve vorm wordt niet correct geplaatst.  <br><br>**Resolutie** <br> Open CRX-DE lijst, navigeer aan `/content/forms/af/`, open de `jcr:content` knoop, en plaats waarde van de knoop aan de correcte taal. Voor de lijst van gesteunde talen, zie [ localisatiesteun voor niet-gesteunde scènes ](https://experienceleague.adobe.com/docs/experience-manager-65/forms/manage-administer-aem-forms/supporting-new-language-localization.html#add-localization-support-for-non-supported-locales) toevoegen. | ![Kan geen verbinding maken met de service.](assets/aem-forms-translation-project-language-unavailable.png) |
